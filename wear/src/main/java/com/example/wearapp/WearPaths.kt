...
object WearPaths {
    ...
    const val CMD_EQ_BIKE = "eq:bike"
    const val CMD_EQ_PLANE = "eq:plane"
    const val CMD_EQ_FOCUS = "eq:focus"
    const val CMD_EQ_EAT = "eq:eat"
    const val CMD_EQ_LIVE = "eq:live"
    const val CMD_EQ_DOSE = "eq:dose"
