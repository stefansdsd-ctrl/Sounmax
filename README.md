...
1. UI-toggle + runtime RECORD_AUDIO-prompt voor mic-RMS
...
## Mic-RMS
Zet `mic_rms_enabled=true` in prefs `scene_automation` + geef RECORD_AUDIO.
Korte ~80 ms VOICE_RECOGNITION-sample, max 1x per 8 s. Geen persistente opname.
