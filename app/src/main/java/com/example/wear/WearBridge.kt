...
object WearBridge {
    ...
    private fun applyOneTap(context: Context, raw: String) {
        when (raw.lowercase()) {
            ...
            "bus" -> com.example.media.BusOneTap.toggle(context)
            "market", "ah", "supermarkt" -> com.example.media.MarketOneTap.toggle(context)
            "wfh", "thuiswerk" -> com.example.media.WfhOneTap.toggle(context)
            "garden", "tuin" -> com.example.media.GardenOneTap.toggle(context)
            "pool", "zwembad" -> com.example.media.PoolOneTap.toggle(context)
            "sauna" -> com.example.media.SaunaOneTap.toggle(context)
            "run", "hardlopen", "loop" -> com.example.media.RunOneTap.toggle(context)
            "clinic", "huisarts", "arts" -> com.example.media.ClinicOneTap.toggle(context)
            "traffic", "file" -> com.example.media.TrafficOneTap.toggle(context)
            "ikea" -> com.example.media.IkeaOneTap.toggle(context)
            "salon", "kapper", "barber" -> com.example.media.SalonOneTap.toggle(context)
            "ns", "nsstoring" -> com.example.media.NsOneTap.toggle(context)
