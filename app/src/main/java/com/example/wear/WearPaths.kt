...
object WearPaths {
    ...
    const val CMD_CYCLE_PROFILE = "cycle_profile"
    const val CMD_APPLY_DEFAULT = "apply_default"
    const val CMD_PIN_DEFAULT = "pin_default"
    const val CMD_AUTO_PROFILE = "auto_profile"
    const val CMD_TOGGLE_GUARD = "toggle_guard"
