...
object SceneLookup {
    val ALL: List<ListeningScene> =
        (ListeningScenes.ALL + ExtraListeningScenes.ALL + NewNlScenes.ALL +
            ...
            Batch81Scenes.ALL + Batch82Scenes.ALL + Batch83Scenes.ALL + Batch84Scenes.ALL + Batch85Scenes.ALL + Batch86Scenes.ALL + Batch87Scenes.ALL + Batch88Scenes.ALL + Batch89Scenes.ALL)
            .distinctBy { it.id }
