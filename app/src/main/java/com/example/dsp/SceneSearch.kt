...
object SceneSearch {
    ...
    private val ALIASES = mapOf(
        ...
        "kringloop" to setOf("thriftshop", "kringloophal"),
        ...
        "gehoor" to setOf("hearrest", "earfatigue", "oorpauze"),
        ...
        "regen" to setOf("rainwalkplus", "rain", "regenoverkapping"),
        "keuken" to setOf("kitchensteam", "kitchen", "cook", "keukentafelavond"),
        "nachtwerk" to setOf("latefocus", "latework"),
        "perron" to setOf("platformrush", "train", "transferhub", "regenoverkapping"),
        ...
        "droger" to setOf("wasruimte", "wasdrogerthuis"),
        "wasmachine" to setOf("wasruimte", "thuiswassen"),
        ...
        "polder" to setOf("polderweg", "polderbus"),
        ...
        "zolder" to setOf("zolderwerk"),
        "bakfiets" to setOf("bakfietsrit"),
        "parkeerdek" to setOf("parkeerdek"),
        "print" to setOf("printkamer"),
        "brievenbus" to setOf("brievenbusrij"),
        "sluis" to setOf("sluiswacht"),
        "koerier" to setOf("fietskoerier"),
        "fietskoerier" to setOf("fietskoerier"),
        "overkapping" to setOf("regenoverkapping"),
        "wassen" to setOf("thuiswassen", "wasdrogerthuis"),
        "portier" to setOf("nachtportier"),
        "nachtportier" to setOf("nachtportier"),
        "collegeopname" to setOf("collegeopname"),
        "opname" to setOf("collegeopname"),
        "polderbus" to setOf("polderbus"),
        "oorpauze" to setOf("oorpauze"),
        "oor" to setOf("oorpauze", "hearrest", "earfatigue")
    )
