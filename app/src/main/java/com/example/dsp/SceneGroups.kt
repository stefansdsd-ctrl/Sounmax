...
object SceneGroups {
    val LABELS: List<Pair<String, Set<String>>> = listOf(
        ...
        "Onderweg" to setOf(
            ...
            "schoolfiets", "treinbistro", "nachtparkeer",
            "bagageband", "roltrap", "perronkap", "garagepoort",
            "regenspitsfiets", "nsstoringperron", "autowegfile", "windfietsplus"
        ),
        "Werk" to setOf(
        ...
        "Media" to setOf(
            ...
            "f1", "podcast_nl", "commentary", "bedpodcast", "museum_night", "voiceboost", "concertzaal", "voetbal_thuis", "museum", "bioscoop", "bioscoopfoyer", "theaterzaal", "bioscoopzaal", "kerkzaal", "thuisbioscoop", "collegeopname", "stilconcert"
        ),
        "Genre" to setOf(
