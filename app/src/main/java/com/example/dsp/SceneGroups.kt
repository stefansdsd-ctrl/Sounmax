...
object SceneGroups {
    val LABELS: List<Pair<String, Set<String>>> = listOf(
        ...
        "Onderweg" to setOf(
            ...
            "garageecho", "morningbike", "nighttram", "trackwork", "nightbusplus", "transferhub", "platformrush", "rainwalkplus"
        ),
        "Werk" to setOf(
