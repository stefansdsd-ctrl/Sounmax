...
object SceneGroups {
    val LABELS: List<Pair<String, Set<String>>> = listOf(
        ...
        "Media" to setOf(
            ...
            "f1", "podcast_nl", "commentary", "bedpodcast", "museum_night", "voiceboost", "concertzaal", "voetbal_thuis", "museum", "bioscoop", "bioscoopfoyer", "theaterzaal", "bioscoopzaal", "kerkzaal"
        ),
        "Genre" to setOf(
