...
object SceneGroups {
    val LABELS: List<Pair<String, Set<String>>> = listOf(
        ...
        "Werk" to setOf(
            ...
            "morningbrief", "voiceisolate", "softcall"
        ),
