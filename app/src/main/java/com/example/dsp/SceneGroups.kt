...
object SceneGroups {
    val LABELS: List<Pair<String, Set<String>>> = listOf(
        ...
        "Werk" to setOf(
            ...
            "hackathon", "collegezaal", "treinwerk", "praat", "bibliotheekstil", "kantooropen"
        ),
