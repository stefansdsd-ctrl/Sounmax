...
object BestNow {
    ...
    private fun noiseBias(scene: ListeningScene): Int {
        ...
        return when {
            ...
            n <= 0.28f && scene.id in setOf("sleep", "night", "libraryplus", "stiltewerk", "hearrest", "cbrtheorie", "practicumlab", "sauna", "werkcollege", "teamsvergadering", "uitvaart", "kantoortuin") -> 14
