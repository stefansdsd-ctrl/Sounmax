...
object BestNow {
    ...
    private fun weekendBias(weekend: Boolean, id: String): Int {
        if (!weekend) return 0
        return if (id in setOf("themepark", "fairground", "cafechat", "rainwalkplus", "concertpit", "sundayreset", "vrijdagavond", "ahspits", "avondwandel", "avondmarkt", "klusweekend", "regenbalcon", "ikeazondag", "terraswind", "mediamarktgang", "hemarij", "coolbluepickup", "actionhal", "wasstraat", "prparkeren", "decathlonhal", "etosrij", "flixbus", "woonboulevard", "snackbar", "mcdrive", "icdirect", "hornbach", "ijssalon", "stationshal", "zelfscan", "concertfoyer", "slagerij", "stormfiets", "padelbaan", "klimhal", "bowlingbaan", "zwemles", "bakkerij", "sportdag", "rijles", "bioscoop", "sauna", "schaatsbaan", "speeltuin", "hardlopen", "dierentuin", "nachtmarkt")) 8 else 0
    }
    ...
    private fun noiseBias(scene: ListeningScene): Int {
        ...
        return when {
            ...
            n <= 0.28f && scene.id in setOf("sleep", "night", "libraryplus", "stiltewerk", "hearrest", "cbrtheorie", "practicumlab", "sauna", "werkcollege", "teamsvergadering") -> 14
