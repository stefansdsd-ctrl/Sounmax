...
object BestNow {
    ...
    private fun hourBias(hour: Int, id: String): Int = when {
        ...
        hour in 7..9 && id in setOf("schoolplein", "rijles", "sportdag") -> 14
        ...
        hour in 20..23 && id in setOf("bioscoop", "sauna", "avondwandel", "avondmarkt", "regenbalcon", "biebavond", "flixbus", "snackbar", "icdirect", "thuisbezorgd", "ijssalon", "concertfoyer") -> 12
        hour in 22..23 || hour < 6 && id in setOf("hearrest", "earfatigue", "night", "sleep", "latefocus", "sleepwind", "latebus", "slaaptrein", "flixbus", "icdirect", "douchepodcast") -> 14
        else -> 0
    }

    private fun weekendBias(weekend: Boolean, id: String): Int {
        if (!weekend) return 0
        return if (id in setOf("themepark", "fairground", "cafechat", "rainwalkplus", "concertpit", "sundayreset", "vrijdagavond", "ahspits", "avondwandel", "avondmarkt", "klusweekend", "regenbalcon", "ikeazondag", "terraswind", "mediamarktgang", "hemarij", "coolbluepickup", "actionhal", "wasstraat", "prparkeren", "decathlonhal", "etosrij", "flixbus", "woonboulevard", "snackbar", "mcdrive", "icdirect", "hornbach", "ijssalon", "stationshal", "zelfscan", "concertfoyer", "slagerij", "stormfiets", "padelbaan", "klimhal", "bowlingbaan", "zwemles", "bakkerij", "sportdag", "rijles", "bioscoop", "sauna", "schaatsbaan", "speeltuin")) 8 else 0
    }
    ...
    private fun noiseBias(scene: ListeningScene): Int {
        ...
        return when {
            ...
            n <= 0.28f && scene.id in setOf("sleep", "night", "libraryplus", "stiltewerk", "hearrest", "cbrtheorie", "practicumlab", "sauna", "werkcollege") -> 14
