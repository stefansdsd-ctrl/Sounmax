...
## Batch 39 (software, deze commit)
- Home-chip **Herstel scene**: laatste luister-scene + DSP + volume-ramp
- Weekdigest: piekdag + uren in balk, zondagavond-notificatie
- Wear: ANC + Zoek in één compacte chiprij
...
## Batch 37 (roadmap)
- Wear-tile: compacte chiprij (◀ scene ▶ + slaap + ANC)
- RemoteViews-hoofdwidget + favorieten uitfaseren (alleen Glance)
- Find-headset: piep/flash via GATT (nu A2DP-hint + RSSI)
